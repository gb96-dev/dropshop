...
class StatisticsServiceTest {
    ...
    void getPopularProducts_usesRedis_whenNoFilterAndRedisHasData() {
        ...
        given(popularProductRedisService.getTopProductsWithScores(5))
        ...
        List<PopularProductResponse> result =
                statisticsService.getPopularProducts(null, null, null, 5);
        ...
        verify(statisticsRepository, never())
                .findPopularProducts(any(), any(), any(), anyInt());
    }
    ...
    void getPopularProducts_fallsBackToDb_whenRedisEmpty() {
        ...
        PopularProductResponse dbResponse = new PopularProductResponse(
                200L, "청바지", "의류", 15L, BigDecimal.valueOf(300000));
    ...
    void getPopularProducts_usesDb_whenDateFilterPresent() {
        ...
        PopularProductResponse dbResponse = new PopularProductResponse(
                300L, "반팔티", "의류", 50L, BigDecimal.valueOf(500000));
        given(statisticsRepository.findPopularProducts(any(), any(), eq(null), eq(5)))
                .willReturn(List.of(dbResponse));

        // when
        List<PopularProductResponse> result =
                statisticsService.getPopularProducts(from, to, null, 5);
    ...
    private ZSetOperations.TypedTuple<Long> mockTuple(Long value, double score) {
        return new ZSetOperations.TypedTuple<>() {
            ...
            @Override public int compareTo(ZSetOperations.TypedTuple<Long> o) {
